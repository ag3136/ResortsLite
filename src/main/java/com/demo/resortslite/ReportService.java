...
public class ReportService {
     ...
     * VIOLATION cr-java-0088: Plain HTTP URL hardcoded for report download.
     * 
     ...
     * FIXED: Using java.time.LocalDateTime instead of legacy Date API
     * 
     * @return Map containing system information
     */
    public Map<String, Object> getSystemInfo() {
        // FIXED: Using java.time API (Java 8+) instead of legacy Date/SimpleDateFormat
