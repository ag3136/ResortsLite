 ...
 * Enables distributed caching and externalized session state
...
public class RedisConfig {
    ...
    /**
     * Configures the Redis connection factory using externalized
    ...
    /**
     * Configures a RedisTemplate with JSON serialization for
